    ...
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      ...
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="/assets/JOYDEEP_resume.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <div
            ...
            <motion.div
                ...
                <div>
                  <div className="flex  gap-4">
                    <motion.a
                      ...
                      href="https://github.com/joydeep2810"
                      target="_blank">
                    ...
                    <motion.a
                      ...
                      href="https://www.instagram.com/_.joydeep._/"
                      target="_blank">
                      <span className="w-10 h-10 text-xl bg bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                        <SlSocialInstagram />
                      </span>
              ...
              <motion.a
                ...
                className="text-sm w-72 tracking-widest text-center text-textGreen mt-4"
                href="mailto:joydeepdas2810@gmail.com">
                <p>joydeepdas2810@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
